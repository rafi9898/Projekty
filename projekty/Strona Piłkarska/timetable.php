            ...
            <div id="nav">
                ...
                <ol>
                    ...
                    <div class="pick">
                            ...
                            <a href="#"><img class="real" src="img/real-madrid.png" alt="Logo Real Madrid przezroczyste"></a>
                
                            <a href="#"><img class="barca" src="img/barcelona.png" alt="Logo Barcelona przezroczyste"></a>
                        
                            <a href="#"><img class="Bayern" src="img/Bayern.png" alt="Logo Bayern"></a>
...
<div class="left-menu">
    <ul>
        ...
        <li>
            <a href="#" target="_blank">Oglądaj</a>
        </li>
        <li>
            <hr>
        </li>
